...
extern uint32_t AES_HW_Init(aes_parcel_t *parcel, bool mode, bool sw_hw_key);
extern uint32_t AES_HW_DeInit();
extern uint32_t AES_HW_Encrypt();
extern uint32_t AES_HW_Decrypt();
