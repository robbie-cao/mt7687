...
hal_adc_status_t hal_adc_init(void)
{
    ...
    DRV_Reg32(IOT_GPIO_AON_ADC_EN) |= (PAD_WF_RF_DIS_B_PINMUX_AON_ADC0_EN_MASK |
                                       PAD_BT_RF_DIS_B_PINMUX_AON_ADC1_EN_MASK |
                                       PAD_WF_LED_B_PINMUX_AON_ADC2_EN_MASK    |
                                       PAD_BT_LED_B_PINMUX_AON_ADC3_EN_MASK);
