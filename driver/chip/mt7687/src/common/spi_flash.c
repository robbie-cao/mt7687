 ...
 */
unsigned int gSFC_max_data_size = MAX_SFC_GPRAM_SIZE - 32; /* 160 actually in MT7637 HW design */
...
const static struct chip_info chips_data[] = {
    ...
    { "MX25L3223F", 0XC2, 0X20160000, 16384, 256, 0X38, 0X6B, 0XEB},
};
...
ATTR_TEXT_IN_TCM static void flash_Switch_Device_Mode(kal_int32 mode)
{
