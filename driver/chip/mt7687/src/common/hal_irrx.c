        ...
        void                *parameter)
{
    ...
    halIrRxRegisterCallback(LOW_HAL_IRRX_MODE_RC5, (low_hal_irrx_callback_t)callback);
    ...
    uint32_t                        *precision_us)
{
    ...
    halIrRxRegisterCallback(LOW_HAL_IRRX_MODE_PWD, (low_hal_irrx_callback_t)callback);
