...
const char ssl_client_ca_crt_rsa[] =
"-----BEGIN CERTIFICATE-----\r\n"
...
static int ssl_client_start( void )
{
    ...
    mbedtls_printf("ssl_client_start entry");
    ...
    ret = mbedtls_x509_crt_parse( &cacert, (const unsigned char *) ssl_client_ca_crt_rsa,
                          sizeof(ssl_client_ca_crt_rsa) );
    if( ret < 0 )
    {
