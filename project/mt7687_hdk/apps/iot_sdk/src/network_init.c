...
void network_init(void)
{
    ...
    /* WIFI_EVENT_IOT_CONNECT_FAIL event is not ready yet, turn it off by default.*/
    //wifi_connection_register_event_notifier(WIFI_EVENT_IOT_CONNECT_FAIL, wifi_station_connect_fail_event_handler);
}
