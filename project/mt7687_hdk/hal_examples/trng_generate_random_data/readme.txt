...
@par Directory contents
 - Source and header files
   ...
   - hal_examples/trng_generate_random_data/src/system_mt7687.c	  	     MT76x7's clock configuration file
   - hal_examples/trng_generate_random_data/inc/hal_feature_config.h 	 MT76x7's feature configuration file
   - hal_examples/trng_generate_random_data/inc/flash_map.h		         MT76x7's memory layout symbol file.
   - hal_examples/trng_generate_random_data/GCC/startup_mt7687.s	     MT76x7's startup file for GCC.
   - hal_examples/trng_generate_random_data/GCC/syscalls.c		         MT76x7's syscalls for GCC.
   - hal_examples/trng_generate_random_data/MDK-ARM/startup_mt7687.s	 MT76x7's startup file for Keil.

  - Project configuration files using GCC
   - hal_examples/trng_generate_random_data/GCC/feature.mk		    	Feature configuration.
   - hal_examples/trng_generate_random_data/GCC/Makefile		 	    Makefile.
   - hal_examples/trng_generate_random_data/GCC/mt7687_flash.ld			Linker script.

  - Project configuration using Keil
...
@par Run the example
  ...
  - Build the example project with the command, "./build.sh mt7687_hdk trng_generate_random_data " from the SDK root folder and download the bin file to LinkIt 7687 development board.
