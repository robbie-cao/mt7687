...
@par Overview
 ...
 - Features of the example project
   - This example project demonstrates how to use GPIO APIs to pull up and pull down GPIO33 and how to get input data after pull state is changed.
...
@par Hardware and software environment
  ...
  - HDK switches and pin configurations
    - Make sure GPIO33 is disconnected.
...
@par Directory contents
  - Source and header files
   ...
   - hal_examples/gpio_configure_pull_state/src/system_mt7687.c		MT76x7's system clock configuration file.
   - hal_examples/gpio_configure_pull_state/inc/hal_feature_config.h 	MT76x7's feature configuration file.
   - hal_examples/gpio_configure_pull_state/inc/flash_map.h	        MT76x7's memory layout symbol file.
   - hal_examples/gpio_configure_pull_state/GCC/startup_mt7687.s	MT76x7's startup file for GCC.
   - hal_examples/gpio_configure_pull_state/GCC/syscalls.c		MT76x7's syscalls for GCC.
   - hal_examples/gpio_configure_pull_state/MDK-ARM/startup_mt7687.s	MT76x7's startup file for Keil.
  ...
  - Project configuration files using IAR
   - hal_examples/ept_configure_pins_by_ept/EWARM/gpio_configure_pull_state	    IAR project options. Contains the settings for the debugger.
   - hal_examples/ept_configure_pins_by_ept/EWARM/gpio_configure_pull_state	    IAR project file. Contains the project structure in XML format.
   - hal_examples/ept_configure_pins_by_ept/EWARM/gpio_configure_pull_state	    IAR workspace file. Contains project information.
   - hal_examples/ept_configure_pins_by_ept/EWARM/flash.icf	                    Linker script.

@par Run the example
  - Connect board to PC with serial port cable.
  - Build the example project with the command, "./build.sh mt7687_hdk gpio_configure_pull_state" under the SDK root folder and download the bin file to LinkIt 7687 development board.
  - Disconnect GPIO33.
