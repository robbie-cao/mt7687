...
@par Directory contents
  - Source and header files
   ...
   - hal_examples/i2c_communication_with_EEPROM_polling/src/system_mt7687.c		MT76x7's clock configuration file.
   - hal_examples/i2c_communication_with_EEPROM_polling/inc/hal_feature_config.h 		MT76x7's feature configuration file.
   - hal_examples/i2c_communication_with_EEPROM_polling/inc/flash_map.h			MT76x7's memory layout symbol file.
   - hal_examples/i2c_communication_with_EEPROM_polling/GCC/startup_mt7687.s		MT76x7's startup file for GCC.
   - hal_examples/i2c_communication_with_EEPROM_polling/GCC/syscalls.c			MT76x7's syscalls for GCC.
   - hal_examples/i2c_communication_with_EEPROM_polling/MDK-ARM/startup_mt7687.s	MT76x7's startup file for Keil.
  ...
  - Project configuration files using GCC
   ...
   - hal_examples/i2c_communication_with_EEPROM_polling/GCC/mt7687_flash.ld		Linker script.
...
@par Run the example
  ...
  - Build the example project with the command, "./build.sh mt7687_hdk i2c_communication_with_EEPROM_polling" from the SDK root folder and download the bin file to LinkIt 7687 development board.
  - Connect J33.5 and J33.6 to M24C01 EEPROM.
