...
@par Overview
 ...
 - Features of the example project
   - This example project demonstrates how to use the UART port to input and output data with UART DMA mode.
...
@par Directory contents
  - Source and header files
   ...
   - hal_examples/uart_loopback_data_dma/src/system_mt2523.c            MT2523x's clock configuration file.
   - hal_examples/uart_loopback_data_dma/inc/hal_feature_config.h       MT2523x's feature configuration file.
   - hal_examples/uart_loopback_data_dma/inc/memory_map.h               MT2523x's memory layout symbol file.
   - hal_examples/uart_loopback_data_dma/GCC/startup_mt2523.s		MT2523x's startup file for GCC.
   - hal_examples/uart_loopback_data_dma/GCC/syscalls.c	                MT2523x's syscalls for GCC.
   - hal_examples/uart_loopback_data_dma/MDK-ARM/startup_mt2523.s	MT2523x's startup file for Keil.
   - hal_examples/uart_loopback_data_dma/EWARM/startup_mt2523.s		MT2523x's startup file for IAR.
  ...
  - Project configuration files using GCC
   ...
   - hal_examples/uart_loopback_data_dma/GCC/flash.ld		        Linker script.
...
@par Run the example
  ...
  - Build the example project with the command, "./build.sh mt2523_hdk uart_loopback_data_dma bl" from the SDK root folder and download the bin file to the LinkIt 2523 development board.
