...
@par Overview
 ...
 - Features of the example project
   - This example project demonstrates how to use WDT APIs to feed the watchdog.
...
@par Directory contents
  - Source and header files
   ...
   - hal_examples/wdt_feed_watchdog/src/system_mt2523.c			MT2523x's clock configuration file.
   - hal_examples/wdt_feed_watchdog/inc/hal_feature_config.h 		MT2523x's feature configuration file.
   - hal_examples/wdt_feed_watchdog/inc/memory_map.h			MT2523x's memory layout symbol file.
   - hal_examples/wdt_feed_watchdog/GCC/startup_mt2523.s		MT2523x's startup file for GCC.
   - hal_examples/wdt_feed_watchdog/GCC/syscalls.c			MT2523x's syscalls for GCC.
   - hal_examples/wdt_feed_watchdog/MDK-ARM/startup_mt2523.s		MT2523x's startup file for Keil.
  ...
  - Project configuration files using GCC
   ...
   - hal_examples/wdt_feed_watchdog/GCC/flash.ld			Linker script.
...
@par Run the example
  ...
  - Build the example project with the command, "./build.sh mt2523_hdk wdt_feed_watchdog bl" from the SDK root folder and download the bin file to LinkIt 2523 development board.
