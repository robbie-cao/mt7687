...
/* Callback function used to handle alarm interrupt */
static void test_rtc_alarm_callback(void *parameter)
{
    test_rtc_callback = 1;
}

/* Clear RTC time structure */
