...
@par Directory contents
  - Source and header files
   ...
   - hal_examples/ept_configure_pins_by_ept/src/system_mt2523.c		MT2523x's system clock configuration file.
   - hal_examples/ept_configure_pins_by_ept/inc/hal_feature_config.h 	MT2523x's feature configuration file.
   - hal_examples/ept_configure_pins_by_ept/inc/memory_map.h		MT2523x's memory layout symbol file.
   ...
   - hal_examples/ept_configure_pins_by_ept/inc/ept_keypad_drv.h	Keypad basic configuration header file.
   - hal_examples/ept_configure_pins_by_ept/GCC/startup_mt2523.s	MT2523x's startup file for GCC.
   - hal_examples/ept_configure_pins_by_ept/GCC/syscalls.c		MT2523x's syscalls for GCC.
   - hal_examples/ept_configure_pins_by_ept/MDK-ARM/startup_mt2523.s    MT2523x's startup file for Keil.
...
@par Run the example
  - Copy files generated by EPT to the path of target project and make sure that the files can be built(This step has to be done).
   - Copy ept_gpio_var.c and ept_eint_var.c to /project/mt2523_hdk/hal_examples/ept_configure_pins_by_ept/src/.
   - Copy ept_eint_drv.h, ept_gpio_drv.h and ept_keypad_drv.h to /project/mt2523_hdk/hal_examples/ept_configure_pins_by_ept/inc/.
  ...
  - Build the example project with the command, "./build.sh mt2523_hdk ept_configure_pins_by_ept bl" under the SDK root folder and download the binary file to LinkIt 2523 development board.
  - Run the example.
