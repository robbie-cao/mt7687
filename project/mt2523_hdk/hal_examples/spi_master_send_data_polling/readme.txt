...
@par Overview
 ...
 - Example project description
   - This example project shows the API usage of the SPI master module to send data.
 - Features of the example project
   - This example project demonstrates how to use the SPI master APIs to send data with polling mode.
...
@par Directory contents
  - Source and header files
   ...
   - hal_examples/spi_master_send_data_polling/src/system_mt2523.c             MT2523x's system clock configuration file.
   - hal_examples/spi_master_send_data_polling/inc/hal_feature_config.h        MT2523x's feature configuration file.
   - hal_examples/spi_master_send_data_polling/inc/memory_map.h                MT2523x's memory layout symbol file.
   - hal_examples/spi_master_send_data_polling/GCC/startup_mt2523.s            MT2523x's startup file of GCC.
   - hal_examples/spi_master_send_data_polling/GCC/syscalls.c                  MT2523x's syscalls of GCC.
   - hal_examples/spi_master_send_data_polling/MDK-ARM/startup_mt2523.s        MT2523x's startup file of Keil.
  ...
  - Project configuration files using GCC
   ...
   - hal_examples/spi_master_send_data_polling/GCC/flash.ld                    Linker script.
...
@par Run the example
  ...
  - Build the sample project with the command, "./build.sh mt2523_hdk spi_master_send_data_polling bl" under the SDK root folder and download the bin file to LinkIt 2523 development board.
