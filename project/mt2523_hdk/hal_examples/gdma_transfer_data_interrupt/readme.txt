...
@par Directory contents
  - Source and header files
   ...
   - hal_examples/gdma_transfer_data_interrupt/src/system_mt2523.c		        MT2523x's system clock configuration file.
   - hal_examples/gdma_transfer_data_interrupt/inc/hal_feature_config.h 		MT2523x's feature configuration file.
   - hal_examples/gdma_transfer_data_interrupt/inc/memory_map.h		                MT2523x's memory layout symbol file.
   - hal_examples/gdma_transfer_data_interrupt/GCC/startup_mt2523.s		        MT2523x's startup file for GCC.
   - hal_examples/gdma_transfer_data_interrupt/GCC/syscalls.c			        MT2523x's syscalls for GCC.
   - hal_examples/gdma_transfer_data_interrupt/MDK-ARM/startup_mt2523.s	                MT2523x's startup file for Keil.

  - Project configuration files using GCC
   - hal_examples/gdma_transfer_data_interrupt/GCC/feature.mk		    	Feature configuration file.
   - hal_examples/gdma_transfer_data_interrupt/GCC/Makefile		 	        Makefile.
   - hal_examples/gdma_transfer_data_interrupt/GCC/flash.ld			        Linker script. 

  - Project configuration files using Keil
   - hal_examples/gdma_transfer_data_interrupt/MDK-ARM/gdma_transfer_data_interrupt.uvprojx		uVision5 Project File. Contains the project structure in XML format.
...
@par Run the example
  ...
  - Build the example project with the command, "./build.sh mt2523_hdk gdma_transfer_data_interrupt bl" from the SDK root folder and download the bin file to Linkit 2523 development board.
