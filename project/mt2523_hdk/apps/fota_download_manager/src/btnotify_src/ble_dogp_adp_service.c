 ...
 */
void bt_btnotify_ble_gatts_common_callback(ble_event_t event_id, const void *param)
{
 ...
 *  @param[in] event  Bluetooth stack event.
 */
void bt_btnotify_ble_gap_common_callback(ble_event_t event_id, const void *param)
{
