...
#define BT_SPP_TX_BUF_SIZE   (BT_SPP_MIN_TX_BUFSIZE) /*for SPP profile use*/
#define BT_SPP_RX_BUF_SIZE   (BT_SPP_MIN_RX_BUFSIZE) /*for SPP profile use*/
#define BT_NOTIFY_MAX_SUPPORTED_REGISTER_COUNT 10
#define BT_NOTIFY_RECEIVE_BUF_SIZE (BT_SPP_MIN_TX_BUFSIZE+1)
...
typedef struct {
    ...
    uint8_t spp_tx_buf[BT_SPP_TX_BUF_SIZE];
    uint8_t spp_rx_buf[BT_SPP_RX_BUF_SIZE];
} bt_notify_context;
