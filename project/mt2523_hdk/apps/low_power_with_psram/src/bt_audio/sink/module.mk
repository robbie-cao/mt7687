...
BT_SINK_SRC = project/mt2523_hdk/apps/low_power_with_psram/src/bt_audio/sink
...
CFLAGS += -I$(SOURCE_DIR)/project/mt2523_hdk/apps/low_power_with_psram/inc/bt_audio/sink
