...
static unsigned char ATTR_ZIDATA_IN_NONCACHED_RAM_4BYTE_ALIGN g_hci_log_buf[2048];
static unsigned char ATTR_ZIDATA_IN_NONCACHED_RAM_4BYTE_ALIGN g_a2dp_omit_buf[28];
