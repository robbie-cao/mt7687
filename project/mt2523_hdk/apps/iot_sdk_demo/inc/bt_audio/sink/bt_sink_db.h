...
#define BT_SINK_DB_FLUSH_TIMER 10000

#define BT_SINK_DB_DEVICE_INFO "devinfo"
#define BT_SINK_DB_SCAN_INFO "scan"
#define BT_SINK_DB_SDAP_INFO "sdap"

typedef uint8_t(*bt_sink_db_comparator_t)(const uint8_t *record, const void *key);
...
typedef struct {
    ...
    uint16_t count;
    uint16_t used;
    bt_sink_db_comparator_t comparator_function_p;
    uint8_t *buffer_p;
} bt_sink_db_t;
