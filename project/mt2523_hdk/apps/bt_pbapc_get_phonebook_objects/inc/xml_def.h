...
#define FS_Write(A, B, C, D)        (int32_t)0
#define FS_Close(A)                 (int32_t)0
#define FS_Open(A, B)               (int32_t)0
#define FS_CreateDir(A)             (int32_t)0
#define DRM_open_file(A, B, C)      (FS_HANDLE)0
#define DRM_close_file(A)           (int32_t)0
#define DRM_file_pos(A, B)          (int32_t)0
#define DRM_seek_file(A, B, C)      (int32_t)0
#define DRM_read_file(A, B, C, D)   (int32_t)0
