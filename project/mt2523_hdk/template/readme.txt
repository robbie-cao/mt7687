...
@par Directory contents
  - Source and header files
   ...
   - template/src/system_mt2523.c		MT2523x's clock configuration file.
   - template/inc/hal_feature_config.h 		MT2523x's feature configuration file.
   - template/inc/memory_map.h		        MT2523x's memory layout symbol file.
   - template/GCC/startup_mt2523.s		MT2523x's start up file for GCC.
   - template/GCC/syscalls.c			MT2523x's syscalls for GCC.
   - template/MDK-ARM/startup_mt2523.s	        MT2523x's start up file for Keil.

  - Project configuration files using GCC
   - template/GCC/feature.mk		    	Feature configuration.
   - template/GCC/Makefile		 	Makefile.
   - template/GCC/flash.ld			Linker script.
...
@par Run the example
  ...
  - Build the project with the command, "./build.sh mt2523_hdk template bl" from the SDK root folder and download the bin file to LinkIt 2523 development board.
