 ...
 *   - For LinkIt 7687 module, user needs to modify flash_map.h under /project/<board>/apps/<project>/inc/.
 *      Modify FLASH_LOADER_SIZE to adjust start address of the NVDM region.
 *      Modify FLASH_COMM_CONF_SIZE, FLASH_STA_CONF_SIZE and FLASH_AP_CONF_SIZE to adjust size of the NVDM region.
 *   - For LinkIt 7697 module, modify flash_map.h header file under /project/<board>/apps/<project>/inc/.
