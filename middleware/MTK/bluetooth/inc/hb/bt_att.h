 ...
 * @addtogroup GATT
 * @{
 * @addtogroup BLE_ATT GATT Common
 * @{
 * This section defines ATT operation codes, ATT request and response structures, API prototypes,
 * and definitions of GATT UUID and characteristics.
 *
 * Terms and Acronyms
 * ======
 * |Terms                         |Details                                                                  |
...
/**
 * @defgroup BLE_ATT_Common_define Define
 * @{
 * This section defines ATT opcode and error code.
 */
...
#define BT_ATT_ERRCODE_INVALID_PDU                      0x04        /**< The attribute PDU was invalid. */
...
/**
 * @defgroup BLE_ATT_Common_struct Struct
 * @{
 * This section defines basic data structure for the ATT.
 */
...
/**
 *  @brief ATT find info request structure.
 */
BT_PACKED (
typedef struct {
...
/**
 *  @brief ATT find info response structure.
 */
BT_PACKED (
typedef struct {
...
typedef struct {
    ...
    uint8_t handles_info_list[1];      /**< A list of 1 or more Handle Information. */
