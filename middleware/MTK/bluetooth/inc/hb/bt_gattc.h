 ...
 * @addtogroup GATT
 * @{
 * @addtogroup BLE_GATTC GATT Client
 * @{
 * This section introduces the GATTC driver APIs including terms and acronyms, supported features, details on how to use this
 * driver, GATTC function groups, enums, GATTC request and response structures and functions, API prototypes to discover
 * primary services, included services, characteristics and descriptors, and to read/write characteristics/descriptors.
 *
 * Terms and Acronyms
 * ======
 * |Terms                         |Details                                                                  |
 ...
 * - Step 1: GATT Client sends a read by group type request to the GATT Server.
 *  - Sample code:
 *     @code
 ...
 *     @endcode
 *
 * - Step 2: GATT Client processes the response from the GATT Server.
 *  - Sample code:
 *     @code
...
/**
 * @defgroup BLE_GATTC_define Define
 * @{
 * This section defines macros for the GATT Client.
 */

#define BT_GATTC_EXCHANGE_MTU                                 (BT_MODULE_GATT | 0x00010000)      /**< Exchange MTU. */
#define BT_GATTC_DISCOVER_PRIMARY_SERVICE                     (BT_MODULE_GATT | 0x00020000)      /**< Discover all primary services. */
#define BT_GATTC_DISCOVER_PRIMARY_SERVICE_BY_UUID             (BT_MODULE_GATT | 0x00030000)      /**< Discover primary service by service UUID. */
#define BT_GATTC_FIND_INCLUDED_SERVICES                       (BT_MODULE_GATT | 0x00040000)      /**< Find included services. */
#define BT_GATTC_DISCOVER_CHARC                               (BT_MODULE_GATT | 0x00050000)      /**< Discover all characteristics of a service or discover characteristics by UUID. */
#define BT_GATTC_DISCOVER_CHARC_DESCRIPTOR                    (BT_MODULE_GATT | 0x00060000)      /**< Discover all characteristic descriptors. */
#define BT_GATTC_READ_CHARC                                   (BT_MODULE_GATT | 0x00070000)      /**< Read characteristic value or read characteristic descriptors. */
#define BT_GATTC_READ_LONG_CHARC                              (BT_MODULE_GATT | 0x00080000)      /**< Read long characteristic values or read long characteristic descriptors. */
#define BT_GATTC_READ_USING_CHARC_UUID                        (BT_MODULE_GATT | 0x00090000)      /**< Read using characteristic UUID. */
#define BT_GATTC_READ_MULTI_CHARC_VALUES                      (BT_MODULE_GATT | 0x000A0000)      /**< Read multiple characteristic values. */
#define BT_GATTC_WRITE_WITHOUT_RSP                            (BT_MODULE_GATT | 0x000B0000)      /**< Write without response. */
#define BT_GATTC_SIGNED_WRITE_WITHOUT_RSP                     (BT_MODULE_GATT | 0x000C0000)      /**< Signed write without response. */
#define BT_GATTC_WRITE_CHARC                                  (BT_MODULE_GATT | 0x000D0000)      /**< Write characteristic value or write characteristic descriptors. */
#define BT_GATTC_WRITE_LONG_CHARC                             (BT_MODULE_GATT | 0x000E0000)      /**< Write long characteristic value or write long characteristic descriptors. */
#define BT_GATTC_RELIABLE_WRITE_CHARC                         (BT_MODULE_GATT | 0x000F0000)      /**< Reliable writes. */
#define BT_GATTC_EXECUTE_WRITE_REQ                            (BT_MODULE_GATT | 0x00100000)      /**< Execute write request. */
#define BT_GATTC_CHARC_VALUE_NOTIFICATION                     (BT_MODULE_GATT | 0x00110000)      /**< Notification. */
#define BT_GATTC_CHARC_VALUE_INDICATION                       (BT_MODULE_GATT | 0x00120000)      /**< Indication. */
#define BT_GATTC_CHARC_VALUE_CONFIRMATION                     (BT_MODULE_GATT | 0x00130000)      /**< Confirmation. */
/* Application should return one of the error codes BT_ATT_ERRCODE_xxxx for the following two events.
 * 1. BT_STATUS_SUCCESS, execute write completed successfully.
 * 2. Others, GATT server will pass it to the remote client. */
#define BT_GATTS_CHARC_EXECUTE_WRITE                          (BT_MODULE_GATT | 0x00140000)      /**< Execute write. */
#define BT_GATTS_CHARC_AUTHORIZATION_CHECK                    (BT_MODULE_GATT | 0x00150000)      /**< Authorization check. */
...
/**
 * @defgroup BLE_GATTC_struct Struct
 * @{
 * Basic data structure for the GATT Client.
 */
...
BT_PACKED (
typedef struct {
    uint8_t opcode;             /**< Can only be #BT_ATT_OPCODE_READ_BY_GROUP_TYPE_REQUEST. */
...
BT_PACKED (
typedef struct {
    uint8_t attribute_value_length;             /**< The length of the attribute value. */
...
BT_PACKED (
typedef struct {
    uint8_t handle_length;                  /**< The length of value handle. */
...
BT_PACKED (
typedef struct {
    uint8_t attribute_value_length;         /**< The length of attribute value. */
    bt_att_write_command_t *att_req;        /**< A pointer to the strucutre to request for an attribute write command. */
...
BT_PACKED (
typedef struct {
    uint8_t length;                         /**< The length of total response. */
    bt_handle_t connection_handle;          /**< Connection handle. */
...
/**
 *  @brief Read by type value response.
 */
BT_PACKED (
typedef struct {
    uint8_t length;                         /**< The length of total response. */
...
BT_PACKED (
typedef struct {
    uint8_t attribute_value_length;         /**< The length of total response. */
    bt_handle_t connection_handle;          /**< Connection handle. */
...
/**
 * @brief This function sends an exchange MTU request to server.
 * @param[in] connection_handle     is the connection handle.
 * @param[in] req                   is the pointer to the GATT exchange MTU request structure.
 ...
 * @param[in] connection_handle     is the connection handle.
 * @param[in] req                   is the pointer to the GATT discover primary service by UUID request structure.
 * @return                          #BT_STATUS_SUCCESS, the operation completed successfully.
 *                                  #BT_STATUS_FAIL, the operation has failed.
 *                                  #BT_STATUS_OUT_OF_MEMORY, out of memory.
 *                                  #BT_STATUS_CONNECTION_IN_USE, an ongoing request.
 ...
 * @param[in] connection_handle     is the connection handle.
 * @param[in] req                   is the pointer to the GATT find included service request structure.
 * @return                          #BT_STATUS_SUCCESS, the operation completed successfully.
 *                                  #BT_STATUS_FAIL, the operation has failed.
 *                                  #BT_STATUS_OUT_OF_MEMORY, out of memory.
 *                                  #BT_STATUS_CONNECTION_IN_USE, an ongoing request.
 ...
 * @param[in] connection_handle     is the connection handle.
 * @param[in] req                   is the pointer to the discover characteristic request structure.
 * @return                          #BT_STATUS_SUCCESS, the operation completed successfully.
 *                                  #BT_STATUS_FAIL, the operation has failed.
 *                                  #BT_STATUS_OUT_OF_MEMORY, out of memory.
 *                                  #BT_STATUS_CONNECTION_IN_USE, an ongoing request.
 ...
 * @param[in] connection_handle     is the connection handle.
 * @param[in] req                   is the pointer to the discover characteristic descriptors request structure.
 * @return                          #BT_STATUS_SUCCESS, the operation completed successfully.
 *                                  #BT_STATUS_FAIL, the operation has failed.
 *                                  #BT_STATUS_OUT_OF_MEMORY, out of memory.
 *                                  #BT_STATUS_CONNECTION_IN_USE, an ongoing request.
 ...
 * @param[in] connection_handle     is the connection handle.
 * @param[in] req                   is the pointer to the read characteristic request structure.
 * @return                          #BT_STATUS_SUCCESS, the operation completed successfully.
 *                                  #BT_STATUS_FAIL, the operation has failed.
 *                                  #BT_STATUS_OUT_OF_MEMORY, out of memory.
 *                                  #BT_STATUS_CONNECTION_IN_USE, an ongoing request.
 ...
 * @param[in] connection_handle     is the connection handle.
 * @param[in] req                   is the pointer to the read long characteristic request structure.
 * @return                          #BT_STATUS_SUCCESS, the operation completed successfully.
 *                                  #BT_STATUS_FAIL, the operation has failed.
 *                                  #BT_STATUS_OUT_OF_MEMORY, out of memory.
 *                                  #BT_STATUS_CONNECTION_IN_USE, an ongoing request.
...
/**
 * @brief This function reads characteristic of the GATT server by UUID.
 * @param[in] connection_handle     is the connection handle.
 * @param[in] req                   is the pointer to the read using characteristic UUID request structure.
 * @return                          #BT_STATUS_SUCCESS, the operation completed successfully.
 *                                  #BT_STATUS_FAIL, the operation has failed.
 *                                  #BT_STATUS_OUT_OF_MEMORY, out of memory.
 *                                  #BT_STATUS_CONNECTION_IN_USE, an ongoing request.
 ...
 * @param[in] connection_handle     is the connection handle.
 * @param[in] req                   is the pointer to the read multiple characteristic values request structure.
 * @return                          #BT_STATUS_SUCCESS, the operation completed successfully.
 *                                  #BT_STATUS_FAIL, the operation has failed.
 *                                  #BT_STATUS_OUT_OF_MEMORY, out of memory.
 *                                  #BT_STATUS_CONNECTION_IN_USE, an ongoing request.
 ...
 * @param[in] req                   is the pointer to the write without response request structure.
 * @return                          #BT_STATUS_SUCCESS, the operation completed successfully.
 *                                  #BT_STATUS_FAIL, the operation has failed.
 *                                  #BT_STATUS_OUT_OF_MEMORY, out of memory.
 *                                  #BT_STATUS_CONNECTION_IN_USE, an ongoing request.
 ...
 * @param[in] connection_handle     is the connection handle.
 * @param[in] req                   is the pointer to the write characteristic request structure.
 * @return                          #BT_STATUS_SUCCESS, the operation completed successfully.
 *                                  #BT_STATUS_FAIL, the operation has failed.
 *                                  #BT_STATUS_OUT_OF_MEMORY, out of memory.
 *                                  #BT_STATUS_CONNECTION_IN_USE, an ongoing request.
 ...
 * @param[in] req                   is the pointer to the prepare write request structure.
 * @return                          #BT_STATUS_SUCCESS, the operation completed successfully.
 *                                  #BT_STATUS_FAIL, the operation has failed.
 *                                  #BT_STATUS_OUT_OF_MEMORY, out of memory.
 *                                  #BT_STATUS_CONNECTION_IN_USE, an ongoing request.
 ...
 * @param[in] connection_handle     is the connection handle.
 * @param[in] req                   is the pointer to the execute write request structure.
 * @return                          #BT_STATUS_SUCCESS, the operation completed successfully.
 *                                  #BT_STATUS_FAIL, the operation has failed.
 *                                  #BT_STATUS_OUT_OF_MEMORY, out of memory.
 *                                  #BT_STATUS_CONNECTION_IN_USE, an ongoing request.
