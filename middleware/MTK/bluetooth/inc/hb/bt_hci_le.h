...
#ifndef __BT_HCI_LE_H__
#define __BT_HCI_LE_H__
 ...
 * @addtogroup HCI
 * @{
 * This section introduces the HCI specifications including terms and acronyms, supported features, details on how to use this driver,
 * HCI function groups, enums, structures and functions.
 *
 * Terms and Acronyms
 * ======
 * |Terms                         |Details                                                                  |
 ...
 *
 * Step 1. Call the GAP API to set the HCI structures as parameters.
 * Step 2. Call #bt_app_event_callback() to parse the payload of the confirmation event with the HCI confirmation structure.
 *
...
/**
 * @defgroup hbif_hci_le_define Define
 * @{
 */
/**
...
typedef bt_hci_status_t bt_hci_disconnect_reason_t;               /**< Indicates the reason for disconnection. */
...
/**
 * @defgroup hbif_hci_le_struct Struct
 * @{
 */
...
typedef bt_hci_evt_cc_le_long_term_key_request_reply_t bt_hci_evt_cc_le_set_data_length_t;   /**< LE set data length command complete event. */
...
typedef struct {
    ...
    uint16_t          conn_interval_min;                 /**< The minimum value for the connection event interval. The range is from 0x0006 to 0x0C80. */
    uint16_t          conn_interval_max;                 /**< The maximum value for the connection event interval. The range is from 0x0006 to 0x0C80. */
