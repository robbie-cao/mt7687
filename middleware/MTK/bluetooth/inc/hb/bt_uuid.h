...
/**
 * @defgroup bt_uuid_define Define
 * @{
...
/**
 * @defgroup bt_uuid_struct Struct
 * @{
 ...
 */
bt_bool_t bt_uuid_equal(const bt_uuid_t *uuid1, const bt_uuid_t *uuid2);
 ...
 */
bt_bool_t bt_uuid_is_uuid32(const bt_uuid_t *uuid);
 ...
 */
bt_bool_t bt_uuid_is_uuid16(const bt_uuid_t *uuid);
