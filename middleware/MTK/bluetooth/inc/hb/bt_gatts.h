 ...
 *
 * ## Sample code
 * - Step 1: Create GAP service; bt_if_gap_service and related records.
 ...
 *  .required_encryption_key_size = 7, //If the record needs channel encryption, the size of encryption key should be greater than or equal to 7.
 *  .records = bt_if_gap_service_rec
 *  };
 *
 * @endcode
 *
 * - Step 2: Create a GATT service; bt_if_gatt_service and related records.
 * @code
 * //Create each record.
 ...
 * @endcode
 *
 * - Step 3: Create bt_if_gatt_server and collect all services.
...
/**
 * @addtogroup BLE_GATTS_define Define
 * @{
 * This section defines the macros for the GATT Server.
 */
/**
 * Note, when creating a record, the application should synchronize the record's permission and characteristic properties to be read out by the client. When the client requests to read/write the record, the Bluetooth stack checks this permission.
 */
#define BT_GATTS_REC_PERM_READ_SHIFT(mask)               ((mask)<<4) /**< Read permission mask shift. */
#define BT_GATTS_REC_PERM_WRITE_SHIFT(mask)              ((mask)<<0) /**< Write permission mask shift. */
#define BT_GATTS_REC_PERM_READ_MASK                      0xf0 /**< Read permission mask. */
...
#define BT_GATTS_REC_PERM_READABLE_AUTHORIZATION         (BT_GATTS_REC_PERM_READABLE | (BT_GATTS_REC_PERM_READ_SHIFT(BT_GAP_LE_SECURITY_AUTHORIZATION_MASK)))/**< The record is readable only after the application permitted. */
#define BT_GATTS_IS_READABLE(perm)                       (((perm) & BT_GATTS_REC_PERM_READ_MASK)> 0) /**< Checks if the record is readable. */
#define BT_GATTS_REC_PERM_WRITE_MASK                     0x0f /**< Write permission mask. */
...
#define BT_GATTS_REC_PERM_WRITABLE_AUTHORIZATION         (BT_GATTS_REC_PERM_WRITABLE | (BT_GATTS_REC_PERM_WRITE_SHIFT(BT_GAP_LE_SECURITY_AUTHORIZATION_MASK)))/**< The record is writable only after the application permitted. */
...
#define BT_GATTS_CALLBACK_READ                          0 /**< It is used in record's callback #bt_gatts_rec_callback_t(), to notify a read request. */
#define BT_GATTS_CALLBACK_WRITE                         1 /**< It is used in record's callback #bt_gatts_rec_callback_t(), to notify a write request. */
#define BT_GATTS_CALLBACK_PREPARE_WRITE                 2 /**< It is used in record's callback #bt_gatts_rec_callback_t(), to notify a prepare write request. */
/* Please don't change sequence of #BT_GATTS_CALLBACK_EXECUTE_WRITE_CANCEL & #BT_GATTS_CALLBACK_EXECUTE_WRITE_WRITE */
#define BT_GATTS_CALLBACK_EXECUTE_WRITE_CANCEL          3 /**< It is used in record's callback #bt_gatts_rec_callback_t(), to notify an execute write with action cancel request. */
#define BT_GATTS_CALLBACK_EXECUTE_WRITE_WRITE           4 /**< It is used in record's callback #bt_gatts_rec_callback_t(), to notify an execute write with action write request. */
 ...
 * @}
 */
typedef uint8_t bt_atts_rec_perm_t; /**<bt_atts_rec_perm_t is a member of #bt_gatts_service_rec_t. It is used to store the record's read/write security permission. */

/* --------------extern UUID --------------------- */
extern const bt_uuid_t BT_GATT_UUID_PRIMARY_SERVICE;            /**< Refer to #BT_GATT_UUID16_PRIMARY_SERVICE */
extern const bt_uuid_t BT_GATT_UUID_SECONDARY_SERVICE;          /**< Refer to #BT_GATT_UUID_SECONDARY_SERVICE */
extern const bt_uuid_t BT_GATT_UUID_INCLUDED_SERVICE;           /**< Refer to #BT_GATT_UUID_INCLUDED_SERVICE */
extern const bt_uuid_t BT_GATT_UUID_CHARC;                      /**< Refer to #BT_GATT_UUID_CHARC */
extern const bt_uuid_t BT_GATT_UUID_CHARC_EXTENDED_PROPERTIES;  /**< Refer to #BT_GATT_UUID_CHARC_EXTENDED_PROPERTIES */
extern const bt_uuid_t BT_GATT_UUID_CHARC_USER_DESCRIPTION;     /**< Refer to #BT_GATT_UUID_CHARC_USER_DESCRIPTION */
extern const bt_uuid_t BT_GATT_UUID_CLIENT_CHARC_CONFIG;        /**< Refer to #BT_GATT_UUID_CLIENT_CHARC_CONFIG */
extern const bt_uuid_t BT_GATT_UUID_SERVER_CHARC_CONFIG;        /**< Refer to #BT_GATT_UUID_SERVER_CHARC_CONFIG */
extern const bt_uuid_t BT_GATT_UUID_CHARC_FORMAT;               /**< Refer to #BT_GATT_UUID_CHARC_FORMAT */
extern const bt_uuid_t BT_GATT_UUID_CHARC_AGGREGATE_FORMAT;     /**< Refer to #BT_GATT_UUID_CHARC_AGGREGATE_FORMAT */

/* -------- callback format ------ */
/**
 * @brief This function is the record's callback called by the GATTS to read/write the record's attribute value.
 ...
 * @param[in] offset is the offset of the attribute value. The read/write starts from the start address of attribute value plus the offset.
 * @return
...
/**
 * @addtogroup BLE_GATTS_struct Struct
 * @{
 * This section defines the basic data structures for the GATT Server.
 */
/**
 *  @brief Record structure of the GATT server.
 */
typedef struct {
    const bt_uuid_t *uuid_ptr; /**< A pointer to the UUID of attribute type. */
    bt_atts_rec_perm_t perm;   /**< The read/write permission and security requirement of the attribute, #BT_GATTS_REC_PERM_READABLE, #BT_GATTS_REC_PERM_WRITABLE. */
    uint8_t value_len;         /**< The length of the attribute value. If the value_len is 0, the record has a callback #bt_gatts_rec_callback_t(), followed by this struct. GATTS will call the record's callback to read/write the attribute value.*/
} bt_gatts_service_rec_t;

/* -------- Service ---------------------------- */
/**
 *  @brief Service structure of the GATT server.
 */
typedef struct {
...
/**
 *  @brief Request the GATT server to do the execute write.
 */
typedef struct {
    uint16_t handle;  /**< The attribute handle. */
    uint8_t flag;     /**< The flag indicating whether to execute write or not. */
} bt_gatts_execute_write_req_t;

/**
 *  @brief Authorization check with application.
 */
BT_PACKED (
typedef struct {
...
/**
*  @brief Included service value structure of the GATT server.
*/
BT_PACKED(
typedef struct {
    ...
    uint16_t uuid16;            /**< If the UUID16 is 0x0000, it's a vender UUID, which does not need to be shown to the client. */
}) bt_gatts_included_service_value_t;

/**
*  @brief Characteristic UUID16 value structure of the GATT server.
*/
BT_PACKED(
typedef struct {
...
/**
*  @brief Characteristic UUID128 value structure of the GATT server.
*/
BT_PACKED(
typedef struct {
    uint8_t properties;     /**< The property of the characteristic value. */
...
/**
*  @brief Characteristic value structure of the GATT server.
*/
BT_PACKED(
typedef struct {
    BT_PACKED(
    union{
        ...
        bt_gatts_rec_callback_t callback;   /**< If the length rec_hdr.value_len is 0, the callback should handle the read and write request. */
    });
}) bt_gatts_characteristic_value_t;

/**
*  @brief Characteristic format value structure of the GATT server.
*/
BT_PACKED(
typedef struct {
...
/**
*  @brief 16-bit primary service structure of the GATT server.
*/
typedef struct {
...
/**
*  @brief 16-bit secondary service structure of the GATT server.
*/
typedef bt_gatts_primary_service_16_t bt_gatts_secondary_service_16_t;

/**
*  @brief 128-bit primary service structure of the GATT server.
*/
typedef struct {
    // Permission: #BT_GATTS_REC_PERM_READABLE
    bt_gatts_service_rec_t rec_hdr;     /**< The record, which is the basic element of a service or characteristic. */
...
/**
*  @brief 128-bit secondary service structure of the GATT server.
*/
typedef bt_gatts_primary_service_128_t bt_gatts_secondary_service_128_t;

/**
*  @brief Included service structure of the GATT server.
*/
typedef struct {
    // Permission: #BT_GATTS_REC_PERM_READABLE
    bt_gatts_service_rec_t rec_hdr;     /**< The record, which is the basic element of a service or characteristic. */
...
/**
*  @brief 16-bit UUID characteristic structure of the GATT server.
*/
typedef struct {
    // Permission: #BT_GATTS_REC_PERM_READABLE
    bt_gatts_service_rec_t rec_hdr;     /**< The record, which is the basic element of a service or characteristic. */
...
/**
*  @brief 128-bit UUID characteristic structure of the GATT server.
*/
typedef struct {
    // Permission: #BT_GATTS_REC_PERM_READABLE
    bt_gatts_service_rec_t rec_hdr;     /**< The record, which is the basic element of a service or characteristic. */
...
/**
*  @brief Characteristic structure of the GATT server.
*/
typedef struct {
...
/**
*  @brief utf-16 characteristic structure of the GATT server.
*/
typedef struct {
    // Permission: Application define
    bt_gatts_service_rec_t rec_hdr;     /**< The record, which is the basic element of a service or characteristic. */
...
/**
*  @brief Half word characteristic structure of the GATT server.
*/
typedef struct {
    // Permission: Application define
    bt_gatts_service_rec_t rec_hdr;     /**< The record, which is the basic element of a service or characteristic. */
...
/**
*  @brief Characteristic extended properties descriptor structure of the GATT server.
*/
typedef struct {
    // Permission: #BT_GATTS_REC_PERM_READABLE
    bt_gatts_service_rec_t rec_hdr;     /**< The record, which is the basic element of a service or characteristic. */
...
/**
*  @brief Characteristic user description descriptor structure of the GATT server.
*/
typedef struct {
    // Permission: Application define
    bt_gatts_service_rec_t rec_hdr;     /**< The record, which is the basic element of a service or characteristic. */
...
/**
*  @brief Characteristic user description str16 descriptor structure of the GATT server.
*/
typedef bt_gatts_characteristic_str16_t bt_gatts_characteristic_user_description_str16_t;

/**
*  @brief Client characteristic configuration descriptor structure of the GATT server.
*/
typedef struct {
...
/**
*  @brief Server characteristic configuration descriptor structure of the GATT server.
*/
typedef bt_gatts_client_characteristic_config_t bt_gatts_server_characteristic_config_t;

/**
*  @brief Characteristic presentation format descriptor structure of the GATT server.
*/
typedef struct {
    // Permission: #BT_GATTS_REC_PERM_READABLE
    bt_gatts_service_rec_t rec_hdr;     /**< The record, which is the basic element of a service or characteristic. */
...
/**
*  @brief Characteristic aggregate format descriptor structure of the GATT server.
*/
typedef struct {
    // Permission: #BT_GATTS_REC_PERM_READABLE
    bt_gatts_service_rec_t rec_hdr;     /**< The record, which is the basic element of a service or characteristic. */
...
* @addtogroup BLE_GATTS_define Define
* @{
* This section describes the macros defined for the GATT Server.
*/
 ...
 * @param[in] max_mtu               is the maximum MTU size in the range from 23 to 512.
