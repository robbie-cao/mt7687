...
#if !(defined(MT2523)||defined(__JPEG_SENSOR_SUPPORT__)||defined(__LOW_COST_SUPPORT_COMMON__)||defined(__MMI_MAINLCD_480X800__)||defined(__MMI_MAINLCD_800X480__))
    //#define __CAL_ADVANCED_IMAGE_EFFECT_SUPPORT__
#endif

#if defined(MT2523)||defined(MT2501)||defined(MT2502)
