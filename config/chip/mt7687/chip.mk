...
COM_CFLAGS += -DCFG_SUPPORT_SMNT_PROTO=3
else
COM_CFLAGS += -DCFG_SUPPORT_SMNT_PROTO=2
endif
...
##
## MTK_MPERF_ENABLE
## Brief:       This option is to enable and disable profiling tool, it supports only GCC based environment and is not to be used by developers/users. Default should be off.
...
ifeq ($(MTK_ALINK_ENABLE),y)
COM_CFLAGS += -I$(SOURCE_DIR)/middleware/third_party/cloud/ali_alink/inc
endif
ifeq ($(MTK_AIRKISS_ENABLE),y)
COM_CFLAGS += -I$(SOURCE_DIR)/middleware/third_party/cloud/tencent_weixin/inc
endif
